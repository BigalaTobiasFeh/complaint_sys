    ...
    <div className="min-h-screen bg-gradient-to-br from-accent to-accent-blue">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-lg">
          <h2 className="text-3xl font-bold text-center text-primary mb-8">Who Can Use NAHPi Complains?</h2>
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Manage user accounts, assign complaints to departments, monitor resolution processes, and generate reports.</p>
            </div>
      ...
      <footer className="bg-primary text-white py-8 mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-lg font-semibold mb-2">NAHPi Complains</p>
